...
<div id="container" class="container_full">
	<div class="main-slider-applyclass" style="background-color:#e7e7e7"><!-- 관리자 li당 background-color 컬러값입력받아서 삽입 -->
			...
			<div class="inner">
				...
				<div class="f-r">
					...
					<div class="new-schedule">
						<div class="main-tit-box-h3">
							<h3 class="main-tit-h3">학사일정</h3>
						</div>
						<dl>
							<dt><strong>D-07</strong> 2017년 7월 1기 모집</dt>
							<dd>
								<p>
					...
					<div class="new-lecture">
						...
						<ul class="tab-category2">
							<li><a href="#"><span>근로자카드</span></a></li><!-- class="on" 활성화 -->
							<li class="on"><a href="#"><span>사업주지원</span></a></li>
